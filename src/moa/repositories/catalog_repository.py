...
from moa.repositories.kakera_state_repository import (
...
from moa.repositories.sphere_result_repository import (
    SphereResultRepository,
...
class CatalogRepository:
    ...
    def __init__(self, database_path: Path | None = None) -> None:
        ...
        self._timer_state_repository = TimerStateRepository(self.database_path)
    ...
    def import_sphere_result(
        ...
        return self._sphere_result_repository.import_sphere_result(
    ...
    def _import_sphere_result_with_connection(
        ...
        *,
        ...
        return self._sphere_result_repository._import_sphere_result_with_connection(
            connection,
            state=state,
            server=server,
            account=account,
    ...
    def sphere_result(self, server_name: str, account_name: str) -> SphereResultObservation | None:
        ...
        return self._sphere_result_repository.sphere_result(server_name, account_name)
    ...
    def import_player_bonus(
        ...
        return self._player_bonus_repository.import_player_bonus(
    ...
    def _import_player_bonus_with_connection(
        ...
        *,
        ...
        return self._player_bonus_repository._import_player_bonus_with_connection(
            connection,
            state=state,
            server=server,
            account=account,
    ...
    def player_bonus(self, server_name: str, account_name: str) -> PlayerBonusObservation | None:
        return self._player_bonus_repository.player_bonus(server_name, account_name)
    ...
    def import_kakera_state(
        ...
        return self._kakera_state_repository.import_kakera_state(
            state, server_name, account_name, raw_message, source
        )
    ...
    def _import_kakera_state_with_connection(
        ...
        *,
        ...
        return self._kakera_state_repository._import_kakera_state_with_connection(
            connection,
            state=state,
            server=server,
            account=account,
    ...
    def kakera_state(self, server_name: str, account_name: str) -> KakeraStateObservation | None:
        return self._kakera_state_repository.kakera_state(server_name, account_name)

    def kakera_history(
        self, server_name: str, account_name: str
    ) -> tuple[KakeraProgressPoint, ...]:
        return self._kakera_state_repository.kakera_history(
    ...
    def import_timer_state(
        ...
        return self._timer_state_repository.import_timer_state(
            state, server_name, account_name, raw_message, source
        )
    ...
    def _import_timer_state_with_connection(
        ...
        *,
        ...
        return self._timer_state_repository._import_timer_state_with_connection(
            connection,
            state=state,
            server=server,
            account=account,
    ...
    def timer_state(self, server_name: str, account_name: str) -> TimerStateObservation | None:
        return self._timer_state_repository.timer_state(server_name, account_name)
    ...
    def import_kakeraloot_state(
        ...
        return self._kakeraloot_state_repository.import_kakeraloot_state(
            state, server_name, account_name, raw_message, source
        )
    ...
    def _import_kakeraloot_state_with_connection(
        ...
        *,
        ...
        return self._kakeraloot_state_repository._import_kakeraloot_state_with_connection(
            connection,
            state=state,
            server=server,
            account=account,
    ...
    def kakeraloot_state(
        ...
        return self._kakeraloot_state_repository.kakeraloot_state(
            server_name, account_name
        )
